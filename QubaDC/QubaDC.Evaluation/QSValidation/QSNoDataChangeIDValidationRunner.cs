...
{
    public class QSNoDataChangeIDValidationRunner
    {
        public void run(MySQLDataConnection con, SystemSetup system, String dbName, int timesQuery,  Boolean addIndexHist)
        {
            ...
            {
                int currentId =  r.Next(2000);
                Output.WriteLine("Extracing ID: " + currentId);
