...
namespace QubaDC.Evaluation.SimpleSystem
{
    class SimpleSelectHandler
    {
        public SimpleSelectHandler(DataConnection c, SchemaManager schemaManager, CRUDRenderer crudRender)
        {
