...
{
    public class SimpleQSSelectHandler : QueryStoreSelectHandler
    {
        ...
        //        };
        //    }
        public override QueryStoreSelectResult HandleSelect(SelectOperation s, SchemaManager schemaManager, DataConnection dataConnection, TableMetadataManager timeManager, CRUDVisitor cRUDHandler, QueryStore qs)
        {
