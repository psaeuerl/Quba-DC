...
namespace QubaDC
{
    public abstract class CRUDVisitor
    {
        ...
        internal abstract string RenderHybridSelectOperation(SelectOperation originalSelect, SchemaInfo s);
        internal abstract string RenderHybridHashSelect(SelectOperation newOperation,SchemaInfo s);
    }
}
